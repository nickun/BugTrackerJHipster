...
using AuthenticationService = BugTracker.Domain.Services.AuthenticationService;
using IAuthenticationService = BugTracker.Domain.Services.Interfaces.IAuthenticationService;
